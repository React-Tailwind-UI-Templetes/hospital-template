...
const Footer = () => {
    return (
        <section id='Contact' className="py-10 dark:bg-gradient-to-r from-[#0C030A] via-slate-950 to-[#2E0B28] sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <h1 className="text-3xl font-bold text-blue-500 ">React TailWindUI</h1>
